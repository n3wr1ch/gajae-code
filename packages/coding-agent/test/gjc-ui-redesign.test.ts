...
const LIGHT_THEME_PAIRINGS = [
	...
	["provider-title", "text", "pageBg", 4.5, "normal-default"],
	["provider-selected", "accent", "pageBg", 4.5, "selected-focus-active"],
	["provider-secondary", "muted", "pageBg", 4.5, "normal-default"],
	["assistant-header", "statusLineModel", "pageBg", 4.5, "status"],
	["assistant-thinking", "thinkingText", "pageBg", 4.5, "pending-loading"],
	["assistant-error", "error", "pageBg", 4.5, "error"],
	["assistant-usage", "dim", "pageBg", 4.5, "status"],
	["tool-pending-title", "toolTitle", "toolPendingBg", 4.5, "pending-loading"],
	["tool-pending-output", "toolOutput", "toolPendingBg", 4.5, "pending-loading"],
	["tool-success-title", "toolTitle", "toolSuccessBg", 4.5, "success"],
	["tool-success-output", "toolOutput", "toolSuccessBg", 4.5, "success"],
	["tool-error-title", "toolTitle", "toolErrorBg", 4.5, "error"],
	["tool-error-output", "toolOutput", "toolErrorBg", 4.5, "error"],
	...
	["chrome-border-accent", "borderAccent", "pageBg", 4.5, "status"],
	["chrome-border-muted", "borderMuted", "pageBg", 3, "normal-default"],
	["user-message-text", "userMessageText", "userMessageBg", 4.5, "normal-default"],
	["custom-message-label", "customMessageLabel", "customMessageBg", 4.5, "expanded"],
	["custom-message-text", "customMessageText", "customMessageBg", 4.5, "expanded"],
	["thinking-off", "thinkingOff", "pageBg", 4.5, "pending-loading"],
	["thinking-minimal", "thinkingMinimal", "pageBg", 4.5, "pending-loading"],
	["thinking-low", "thinkingLow", "pageBg", 4.5, "pending-loading"],
	["thinking-medium", "thinkingMedium", "pageBg", 4.5, "pending-loading"],
	["thinking-high", "thinkingHigh", "pageBg", 4.5, "pending-loading"],
	["thinking-xhigh", "thinkingXhigh", "pageBg", 4.5, "pending-loading"],
	["bash-mode", "bashMode", "pageBg", 4.5, "pending-loading"],
	["python-mode", "pythonMode", "pageBg", 4.5, "pending-loading"],
